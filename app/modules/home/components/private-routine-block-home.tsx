...
import privateRoutineBlockApi, { BlockStatus } from '../../private-routines/api/private-routine-block-api';
...
const PrivateRoutineBlockHome = ({ block, showEditButton = true, stateIconCentered = false }: RoutineBlockItemProps) => {
...
export default PrivateRoutineBlockHome; 